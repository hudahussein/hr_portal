...
public partial class _Employee_Vacation : basePageSessionExpire
{
...

    {
        ...
        using (SqlCommand cmd = new SqlCommand("Select * from adminusers where Dept_id = @Dept_id and Emp_ID <> @Emp_id", con))
...

    {
        ...
        using (SqlCommand cmd = new SqlCommand("Select * from HR_DaysOFF_Requests where ExpirationDate > GETDATE() and Canceled <> 'True' and Status = 4 and Emp_id =" + HttpContext.Current.Session["Emp_ID"], con))
