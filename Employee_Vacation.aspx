...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
					...
					<div class='grouped shadow-sm rounded'>
						<div class='row'>
							...
							<div class="cu-field col-md-6">
								...
								<div class="cu-input text-box"><span class="fa fa-edit"></span> <div><%=Session["admin"]%></div></div>
							</div>
							...
							<div class="cu-field col-md-6">
								...
								<div class="cu-input text-box"><span class="fa fa-edit"></span> <div><%=Session["Emp_ID"]%></div></div>
							</div>
						</div>
					</div>
	...
	<script src='../layout/vue-code/Employee_Vacation.js'></script>
</asp:Content>